 ...
 *
 */
public abstract class Distance2 {
	 ...
	 */
	public abstract double computeSquareDistance(Signal s, GngQNode n);
	 ...
	 * @return the distance
	 */
	public double computeDistance(Signal s, GngQNode n){
	 ...
	 */
	public abstract Vector<Double> computeMiddlePosition(GngQNode node1, GngQNode node2);
